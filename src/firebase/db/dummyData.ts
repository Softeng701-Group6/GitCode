const QUESTIONS = [
    {
        ...
        learningObjective: {
            ...
            outcomeArray: [
                "Understanding Version Control: Students will grasp the concept of version control and how Git enables tracking changes to code over time.",
                ...
                "Committing Changes: Students will learn how to create a commit in Git, understanding the purpose and significance of commit messages in documenting changes.",
